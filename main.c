...
{
    float HeroVertex[] = {obj.x-40,obj.y-50,obj.x+40,obj.y-60,obj.x+40,obj.y+60,obj.x-40,obj.y+60};
...
{
    ChooseBTN(0,3);
    Menu_AddButton("Start",40,40,100,35,2);
    Menu_AddButton("Test",40,90,100,35,2);
    Menu_AddButton("Quit",40,140,100,35,2);
    Menu_AddButton("Anim1",40,40,100,35,2);
    Menu_AddButton("Anim2",40,90,100,35,2);
    Menu_AddButton("Anim3",40,140,100,35,2);
    Menu_AddButton("Back",40,190,100,35,2);
    Menu_AddButton("Back",40,40,100,35,2);
}
...
void InitGame()
{
    Hero_Init(&NekoGirl,height/2,width/2,0.5,0.5);
    ChooseBTN(7,8);
    currentframe=0;
    TypeOfAnim=0;
    anim=1;
